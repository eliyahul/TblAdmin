...
namespace TblAdmin.Areas.Base.Controllers
{
    public abstract class BaseController : Controller
    {
        ...
        //
        // SO, INSTEAD OF:
        //          Object routeValues = new { SearchString = "", SortCol = "name", SortColOrder = SORT_ORDER_ASC, Page = "1", PageSize = "3" };
        ...
        //      5)  Object routeValues = new { SearchString = "", SortCol = "name", SortColOrder = SORT_ORDER_ASC, Page = "1", PageSize = "3" };
